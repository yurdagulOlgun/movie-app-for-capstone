      ...
      <Container>
        <Row>
          ...
          <Col>
            ...
            <Button id="loadmorebutton" className="m-3" variant="secondary" onClick={loadMoreMovies}>
              Load More
            </Button>
          </Col>
        </Row>
    ...
    <>
      <Container>
        <Row>
          ...
          </Row><Button id="loadmorebutton" className="m-3" variant="secondary" onClick={loadMoreMovies}>
            Load More
          </Button>
          </Col>
        </Row>
